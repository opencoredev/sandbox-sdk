...
| [Blaxel](/docs/providers/blaxel)         | <ProviderDocsLink provider="blaxel" />  | Perpetual agent sandboxes            | Linux microVM   | Standby resume | Public or authenticated | Not normalized       |
