...
- Blaxel preserves memory, files, and processes through standby and creates private preview URLs by default; native snapshot configuration is not normalized.
